...
def build_finetune_model(model_new, model_pretrained, num_rnn_layers,
    ...
    for l in range(num_rnn_layers):
        model_new.encoder.gru_gcn.snn_node[l] = model_pretrained.encoder.gru_gcn.snn_node[l]
        model_new.encoder.gru_gcn.snn_edge[l] = model_pretrained.encoder.gru_gcn.snn_edge[l]
        model_new.encoder.gru_gcn.gnnx2[l] = model_pretrained.encoder.gru_gcn.gnnx2[l]
        model_new.encoder.gru_gcn.edge_transform = model_pretrained.encoder.gru_gcn.edge_transform
    return model_new
